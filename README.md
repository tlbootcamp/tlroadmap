...
1. Скачайте себе [карту](https://cdn.jsdelivr.net/gh/tlbootcamp/tlroadmap@master/roadmap.mm) с полной моделью тимлида.
...
1. Откройте [кликабельную версию роадмапа](https://raw.githubusercontent.com/tlbootcamp/tlroadmap/master/roadmap.svg?sanitize=true).
