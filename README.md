...
- [x] Разработать общую структуру рабочих обязанностей тимлида
- [x] Наполнить базу знаний для ветки `Resource Manager`
- [x] Добавить блок личных навыков тимлида (коммуникация, тайм-менеджмент, эмпатия и прочее)
...
- Управление командой
    ...
    - [Климат в команде](team_climate.md)
    - [Зрелость команды](team_maturity.md)
