...
- Играющий тренер в scrum-команде: [png](examples/playing-coach.png), [mindmap](examples/playing-coach.mm)
- Технический лид: [png](examples/techlead.png), [mindmap](examples/techlead.mm)
- Тимлид стартапа: [png](examples/startup-teamlead.png), [mindmap]((examples/startup-teamlead.mmg))
