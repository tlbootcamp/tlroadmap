...
Для всех изменений структуры источником правды является файл `roadmap.mm`. Обновляйте его с помощью [Freemind](https://sourceforge.net/projects/freemind/), после чего запустите скрипт `python3 tools/gen_roadmap_contents.py` для автоматического обновления базы знаний.
...
### Коммуникации
- [Фасилитация (Управление групповой дискуссией)](facilitation.md)
- Сотрудничество
