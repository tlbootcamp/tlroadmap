...
3. Покажите полученный профиль коллегам, подчиненным или руководителю и соберите обратную связь – чего им не хватает с вашей стороны, или какие проблемы они видят.
4. Проведите самооценку с учетом собственного знания слабых сторон и полученной обратной связи, сопоставляя эти факты с примерами хорошего и плохого поведения в каждой ветке.
...
2. Всегда старайтесь подключать кого-то стороннего, чтобы получить фидбэк по вашей собственной модели компетенций. Это может быть руководитель, коллеги или даже сообщество из [нашего Telegram-чата](https://tlinks.run/tlbootcamp).
3. Используйте роадмап не только для себя, но и для других тимлидов в компании. Таким образом, вы все будете общаться на одном языке, и сможете четко определить область ответственности друг друга.
