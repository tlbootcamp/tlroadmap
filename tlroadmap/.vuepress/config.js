...
module.exports = (ctx) => ({
  ...
  themeConfig: {
    ...
    editLinks: true,
    banner: {
      text: 'Мы проводим большой опрос тимлидов про ключевые навыки, условия работы, полезные книги и курсы. Расскажите про свой опыт и помогите получить полезные результаты!',
