...
Если размер команды превышает 8-10 человек, то задача, как и все управление людьми, может быть делегирована на тимлидов ниже уровнем.
...
- Еще один чек-лист проведение one-to-one: https://hbswk.hbs.edu/item/master-the-one-on-one-meeting
