...
## Почему ветка важна?
Увеличение перфоманса команды – одна из ключевых задач руководителя. Эту задачу можно решать при помощи найма, но количество мест в офисе ограничено, также при росте команды добавляются стоимость на управление и усложняются коммуникации. Получается, что со временем единственным хорошим решением становится прокачка текущих людей.

Почему ветка важна для тимлида:
- Один из хороших способов выстраивания отношений руководитель <-> подчиненный.
- Повышение перфоманса конкретного человека.

Почему ветка важна для сотрудника:
