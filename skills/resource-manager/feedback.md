...
- ОС сбалансирована, т.е. содержит и зоны роста и позитивные моменты
- ОС адресуется сотруднику в личной беседе
- ОС своевременна, т.е. дается сразу после наблюдаемого поведения
- ОС конструктивна, даны объяснения, какое поведение правильное/не правильное
