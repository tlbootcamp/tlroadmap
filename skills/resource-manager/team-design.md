...
- Провети дизайн команды опираясь на бэклог, над которым команда будет работать

## Примеры плохого поведения
- Нанять "среднюю по рынку команду" команду: аналитик, дизайнер, разработчки, тестер
- Использовать такие правила, как "1 разработчик - 2 тестера" 

## Способы прокачки

### Ссылки
- [HitMap и воркшоп по формированию команд](http://agilix.ru/mts_5)
...
|---|---|
|1|Лендинг-страница|
|2|Выввод в топ поисковиков|
|3|Форма обратной свзи|
...
Дополните бэклог 2-ым измерением в виде компетенций, которые нужны чтобы данные элементы сделать. На пересечении элементов и компетенций поставьте 
...
|№|Элемент бэклога/Компетенции|PHP|JS|SEO|eМаркетинг|Бух. учет|Админ-вание Linux|
|---|---|---|---|---|---|---|---|
|1|Лендинг-страница|1|1|0|0|0|1|
|2|Выввод в топ поисковиков|0|1|1|1|0|0|
|3|Форма обратной свзи|1|1|0|0|0|0|
|4|Интеграция с ПО управления складом|1|0|0|1|1|1|
|5|Форма онлайн-оплаты|1|1|1|1|1|1|

Можно не ограничиваться бинарной оценкой, эксперементировать с весами и коэффициентами. Если посчитать сумму по столбцам и нормировать их по общей сумме, то получим %-распределение компетенций, которыми должна обладать новая команда.
...
|5|Форма онлайн-оплаты|1|1|1|1|1|1|
| |Сумма|4|4|2|3|2|3|
| |% распеределения|22%|22%|11%|17%|11%|17%|
...
Если учесть, что реальные люди владеют несколькими компетенциями, обшая численность команды может быть снижена за счет совместного перекрытия новыков.

##### 3. Составление "Звездной карты"
Если мы формируем команду из сотрудников компани, а не полностью набираем с рынка, то можем оценить, как они смогут потенциально перекрыть необходимые компетенции. Для этого возьмем список компетенций из п.2, но элементы бэклога заменим нашими сотрудниками.
На пересечении в такой матрице нужно отметить уровенть знаний сотрудника в данном направлении:
- "⭐" - хорошо знаю, могу подсказать
- "👓" - хочу изучить
- " " - не интересно

|№|Сотрудник/Компетенции|PHP|JS|SEO|eМаркетинг|Бух. учет|Админ-вание Linux|
|---|---|---|---|---|---|---|---|
|1|Петя|⭐| |⭐| |👓|👓|
|2|Вася|👓| |⭐| | |⭐|
|3|Коля|👓| |⭐|⭐| | |
...
Как и с прошлым упражнением, можно придумать любую градацию кроме предложенной. Сотрудникам она поможет найтие эксперта в необходимой области, а тимлид "оцифрует ее", что провести анализ. Это можно сделать поменяв пиктограммы на числа и сразу применив нормирование как в п.2:
- "⭐" - 2
- "👓" - 1
- " " - 0
...
|4|Маша|0|2|0|0|1|1| 
| |Сумма|4|2|6|2|2|4|
| |% распеределения|20%|10%|30%|10%|10%|20%|
...
Как видно из сравнения в примере, что компетенции "eМаркетинг" и "Бух. Учет" не могут быть закрыта полностью текущей командой, т.е. это возможные направления в усилении команды за счет найма или обучения.

##### 5. Воркшоп по объединению в команду
Как только вся потенциальная команда собрана, можно дать людям рассказать о себе, просто пообщаться или совместно выполнить какое-либо задание. Далее путем закрытого голосвания определить готовность всех участников стартовать в таком составе. 
