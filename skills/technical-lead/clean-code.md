...
Тимлид помогает команде освоить принципы написания чистого кода и практики поддержания чистоты - например, правило бойскаута и отсутствие ["разбитых окон"](https://pragprog.com/the-pragmatic-programmer/extracts/software-entropy).
