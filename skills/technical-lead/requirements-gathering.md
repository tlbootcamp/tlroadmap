...
## Описание
Сбор технических требований - это этап планирования нового продукта, во время которого необходимо собрать информацию про окружение, в котором будет работать продукт.
